...
<form name="form" id="form" class="form" action="../update_data/update_mapel.php" onKeyUp="highlight(event)" onClick="highlight(event)" onsubmit="return validate(this)" method="post">
<input type="hidden" name="id" value="<?php echo $id; ?>"/>
<center>
<table width="392" height="184" align="center">
  <tr><td>
